  ...
  const testimonials = [
    {
      name: "Maria Silva",
      role: "Empresária",
      text: "Casa DF foi fundamental na compra da minha mansão no Lago Sul. Profissionalismo e atenção aos detalhes impecáveis!",
      rating: 5,
    },
    {
      name: "Carlos Eduardo",
      role: "Investidor",
      text: "Vendi minha cobertura em tempo recorde graças ao trabalho excepcional do Casa DF. Recomendo sem ressalvas!",
      rating: 5,
    },
    {
      name: "Ana Paula",
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <p>
                    Ao longo de sua carreira, Casa DF intermediou a venda de algumas das 
                  ...
                  <p>
                    ...
                    Casa DF combina tradição e inovação para oferecer o melhor serviço aos 
